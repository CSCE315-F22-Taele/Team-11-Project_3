    ...
    <div id="options" class="hidden">
      <fieldset>
       ...
       [@control.text name="identityProvider.usernameClaim" autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false" tooltip=message.inline('{tooltip}identityProvider.usernameClaim')/]
        ...
        [#-- POST handling --]
        [@control.checkbox name="identityProvider.postRequest" value="true" uncheckedValue="false" tooltip=message.inline('{tooltip}identityProvider.postRequest') data_slide_open="saml-request-signing-canonicalization"/]
