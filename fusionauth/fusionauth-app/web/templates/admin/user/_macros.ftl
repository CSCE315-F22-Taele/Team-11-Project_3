...
<table>
  ...
  <tbody>
    [#if refreshTokens?has_content]
      ...
      <tr>
        <td>${properties.display(refreshToken.metaData.device, "name")} [#if thisSession == refreshToken.token || (thisSSOSessionId!'') == refreshToken.id]<span data-toolip="${message.inline("your-computer")}" title="${message.inline("your-computer")}"> &nbsp; <i class="fa fa-laptop green-text"></i></span>[/#if] </td>
