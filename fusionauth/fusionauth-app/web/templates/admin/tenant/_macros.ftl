...
<div id="additional-webauthn-options" class="slide-open [#if tenant.webAuthnConfiguration.enabled]open[/#if]">
  ...
  <fieldset>
    ...
    [@control.checkbox name="tenant.webAuthnConfiguration.bootstrapWorkflow.enabled" value="true" uncheckedValue="false" data_slide_open="webauthn-bootstrap-options"/]
    <div id="webauthn-bootstrap-options" class="slide-open [#if tenant.webAuthnConfiguration.bootstrapWorkflow.enabled]open[/#if]">
  ...
  <fieldset>
    ...
    [@control.checkbox name="tenant.webAuthnConfiguration.reauthenticationWorkflow.enabled" value="true" uncheckedValue="false" data_slide_open="webauthn-reauthentication-options"/]
    <div id="webauthn-reauthentication-options" class="slide-open [#if tenant.webAuthnConfiguration.reauthenticationWorkflow.enabled]open[/#if]">
...
[#macro jwtConfiguration]
  ...
  <fieldset>
    ...
    [@helpers.booleanCheckboxList id="tenant_jwtConfiguration_refreshTokenRevocationPolicy" name="tenant.jwtConfiguration.refreshTokenRevocationPolicy" values=["onLoginPrevented", "onPasswordChanged"] tooltip=message.inline("{tooltip}jwtConfiguration.refreshTokenRevocationPolicy")/]
  </fieldset>
[/#macro]
